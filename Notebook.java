...
//        List<?> valueList = new ArrayList<>(customerSelect.values());
////        System.out.println("valueList = " + valueList);
//        for (Notebook nout: setNout
//             ) {
//            System.out.println(nout.toString());
//            String words = nout.toString();
//
////            String[] words = nout.toString().split(" ");
////            int counterSovpadeniy = 0;
////            for (int i = 0; i < words.length; i++) {
////                if (keysList.contains(words[i]) && valueList.contains(words[i + 1])) {
////                    counterSovpadeniy++;
////                }
////            }
////            if (counterSovpadeniy == words.length) {
////                System.out.println("Вот ноутбук подходящий вашему критерию " + nout);
////        }
//
//        }
...
//        Scanner scanner = new Scanner(System.in);
//        String choiseLine = scanner.nextLine();
//        return choiseLine;
//}
}